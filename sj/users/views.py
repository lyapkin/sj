...
from .models import Otp, FavoriteProduct, FavoriteBrand
from .serializers import OtpSerializer, UserSerializer, FavoriteProductSerializer, FavoriteBrandSerializer
